...
template <typename T> Size<DnaString>::Type transformSequence(
		String<bool> const& pattern,
		Size<DnaString>::Type patternSize,
		Size<DnaString>::Type patternFinalSize,
		DnaString & sequence,
		T & transformee){
...
template <> Size<DnaString>::Type transformSequence<DnaString >(
		String<bool> const& pattern,
		Size<DnaString>::Type patternSize,
		Size<DnaString>::Type patternFinalSize,
		DnaString & sequence,
		DnaString & transformee
){
	...
	//TODO : vraiment necessaire de réserver de la place. Ne vaut-il pas mieux laisser Seqan géré ça ?
...
template <> Size<DnaString>::Type transformSequence<String<uint16_t> >(
		String<bool> const& pattern,
		Size<DnaString>::Type patternSize,
		Size<DnaString>::Type patternFinalSize,
		DnaString & sequence,
